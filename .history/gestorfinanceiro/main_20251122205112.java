...
public class Main{
    public static void main(String[] args) {
        ...
        ContaPoupanca cp = new ContaPoupanca("Minha poupança");
        System.out.println("Poupança criada");
        cp.depositar(100);
        cp.sacar(200);
        System.out.println("Saldo atual da poupança: R$" + cp.getSaldo());

        CartaoCredito credito = new CartaoCredito("Visa", 1000);
        System.out.println("Cartão de credito criado com limite de 1000");
        credito.sacar(500);
        credito.depositar(100);
        System.out.println("Cartão de credito com limite  de R$" + credito.getSaldo());
