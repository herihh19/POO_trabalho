...
public class ServicosInteligentes{
    ...
    public static void analisarGastos(List<Transacao> transacoes){
        ...
        System.out.println("Analise de Gastos");
        System.out.println("Total de despesas: R$ " + totalDespesas);

        if (qtdDespesas > 0){
            double media = totalDespesas/qtdDespesas;
            System.out.println("Media por compra:" media);
            if (media > 200) {
                System.out.println("Sua média de gastos está alta, tente economizar mais");
            } else {
                System.out.println("Seus gastos estão de acordo")
            }
