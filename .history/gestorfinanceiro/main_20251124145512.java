...
public class Main{
        ...
        do{
            ...
            switch(opcao){
                ...
                case 6:
                    ...
                    break;
                case 0:
                    System.out.println("Dados sendo salvos e saindo do sistema");
    ...
    private static void menuInteligencia() {
        ...
        if (op == 1) {
            ContaFinanceira conta = selecionarConta();
            if (conta != null) {
                System.out.print("Quanto quer guardar por mês? R$ ");
                double econ = Double.parseDouble(scanner.nextLine());
