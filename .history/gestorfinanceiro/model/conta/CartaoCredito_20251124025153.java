...
public class CartaoCredito extends ContaFinanceira{
    ...
    public void sacar(double valor){
        if (valor <= this.saldo){
            ...
            System.out.println("Compra negada pois o limite e insuficiente");
        }
    }
    @Override
    ...
    public void depositar(double valor){
        if ((this.saldo + valor) <= this.limiteTotal){
            ...
            this.transacoes.add(new Transacao("Pagamento realizado com troco: R$", this.limiteTotal, TipoTransacao.RECEITA));
